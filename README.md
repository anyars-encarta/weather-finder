...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/weather-finder.JPG" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Weather Finder</b></h3>
...
<!-- INTRO -->
# 📖 Weather Finder<a name="about-project"></a>

> Weather Finder is an interactive app that fetches weather data and displays the metrics on the UI based on the searched location.
...
> - Fetchand and display weather metrics based on specified location
...
```sh
cd weather-finder
https://github.com/anyars-encarta/weather-finder.git
```
